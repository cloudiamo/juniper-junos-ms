...
# Install juniper-junos {{{
COPY --chown=1000:1000 . /opt/fmc_repository/juniper-junos-ms
RUN install_repo_deps.sh /opt/fmc_repository/juniper-junos-ms/

# Cleanup repository {{{
RUN rm -rf /opt/fmc_repository/velocloud-ms/{.git,docker,Dockerfile}
# }}}
# Build tarball {{{
